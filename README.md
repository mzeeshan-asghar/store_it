...
- [pnpm](hhttps://pnpm.io/) (Performant Node Package Manager)

**Cloning the Repository**

```bash
git clone https://github.com/mzeeshan-asghar/store_it.git
cd store_it
```
...
@layer utilities {
  ...
  .shad-input {
    @apply shad-no-focus body-2 border-none p-0 shadow-none placeholder:text-light-200 !important;
  }
  ...
  .shad-form-message {
    @apply body-2 ml-4 text-red !important;
  }
  .shad-alert-dialog {
  ...
  .shad-otp-slot {
    @apply flex size-12 justify-center gap-5 rounded-xl border-2 border-light-300 text-[40px] font-medium text-brand-100 shadow-drop-1 ring-brand md:size-16 !important;
  }
  ...
  .dashboard-recent-files {
    @apply custom-scrollbar h-full overflow-auto rounded-[20px] bg-white p-5 xl:h-[654px] xl:p-7 !important;
  }
  .recent-file-details {
    @apply flex w-full items-center justify-between !important;
  }
  .recent-file-name {
  ...
  .error-toast {
    @apply !rounded-[10px] bg-red !important;
  }
